...
public final class FragmentInboxBinding implements ViewBinding {
  ...
  private FragmentInboxBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recyclerView) {
  ...
  public static FragmentInboxBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentInboxBinding((LinearLayout) rootView, recyclerView);
    }
