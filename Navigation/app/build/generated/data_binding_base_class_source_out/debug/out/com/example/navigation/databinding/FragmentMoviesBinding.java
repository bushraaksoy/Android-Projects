...
public final class FragmentMoviesBinding implements ViewBinding {
  ...
  private FragmentMoviesBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView moviesList, @NonNull TextView title) {
  ...
  public static FragmentMoviesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.moviesList;
      RecyclerView moviesList = ViewBindings.findChildViewById(rootView, id);
      if (moviesList == null) {
        break missingId;
      }
      ...
      return new FragmentMoviesBinding((ConstraintLayout) rootView, moviesList, title);
    }
